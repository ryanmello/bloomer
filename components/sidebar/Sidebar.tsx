  ...
  return (
    <>
      ...
      <aside
        ...
        <div
          className={`flex items-center justify-between transition-opacity duration-300 delay-100 ${isOpen ? "opacity-100" : "opacity-0 xl:opacity-100"}`}>
        ...
        <div
          className={`flex-1 overflow-auto scrollbar-thin transition-opacity duration-300 delay-150 ${isOpen ? "opacity-100" : "opacity-0 xl:opacity-100"}`}>
        ...
        <div
          className={`transition-opacity duration-300 delay-200 ${isOpen ? "opacity-100" : "opacity-0 xl:opacity-100"}`}>
